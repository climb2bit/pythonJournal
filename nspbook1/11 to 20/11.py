...
STATES = ['California', 'Texas', 'Florida', 'New York', 'Pennsylvania',
          'Illinois', 'Ohio', 'Georgia', 'North Carolina', 'Michigan', 'Singapore', 'China']
NOUNS = ['Athlete', 'Clown', 'Shovel', 'Paleo Diet', 'Doctor', 'Parent',
          'Cat', 'Chicken', 'Robot', 'Video Game', 'Avocado', #'doot'
         'Plastic Straw','Serial Killer', 'Telephone Psychic', 'Pot', 'Dog']
PLACES = ['House', 'Attic', 'Bank Deposit Box', 'School', 'Basement',
          'Workplace', 'Donut Shop', 'Apocalypse Bunker', 'subway station']
WHEN = ['Soon', 'This Year', 'Later Today', 'RIGHT NOW', 'Next Week', 'Next month']

def main():
    print('Clickbait Headline Generator')
    print('By Al Sweigart/mango')
    print()
